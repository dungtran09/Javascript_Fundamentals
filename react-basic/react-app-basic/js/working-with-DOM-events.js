...
const App = () => {
  return (
    <React.Fragment>
      {courses.map((course) => {
        return <Secsion key={course.id} course={course} />;
      })}
    </React.Fragment>
  );
};
